    ...
    'KnUser' = @{
        'Element' = @{
            'Fields' = @{
                ...
                # E-mail
                'EmAd' = $null # or "$personId@customer.nl" # Unique value based of PersonId because at the revoke action we want to clear the unique fields.
                # UPN
                'Upn'  = $null # or "$personId@customer.nl" # Unique value based of PersonId because at the revoke action we want to clear the unique fields
